...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-edv-calculation', __webpack_require__(3));
  Vue.component('detail-edv-calculation', __webpack_require__(6));
  Vue.component('form-edv-calculation', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        this.result = JSON.parse(this.field.value);
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.$on('total', function (vale) {
            var _vale = _slicedToArray(vale, 2),
                current = _vale[0],
                prev = _vale[1];

            _this.total = _this.total + current - prev;
        });
        Nova.$on('edvTotal', function (vale) {
            var _vale2 = _slicedToArray(vale, 2),
                current = _vale2[0],
                prev = _vale2[1];

            _this.edv = Number(_this.edv) + Number(current) - Number(prev);
        });
        Nova.$on('priceTotal', function (vale) {
            var _vale3 = _slicedToArray(vale, 2),
                current = _vale3[0],
                prev = _vale3[1];

            _this.priceTotal = Number(_this.priceTotal) + Number(current) - Number(prev);
        });
    }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "relative" }, [
    _c("ul", [
      _c("li", [_vm._v("Cəmi : " + _vm._s(_vm.priceTotal.toFixed(2)))]),
      _vm._v(" "),
      _c("li", [_vm._v("Ədv : " + _vm._s(_vm.edv) + " %")]),
      _vm._v(" "),
      _c("li", [_vm._v("Yekun : " + _vm._s(_vm.total.toFixed(2)))])
    ])
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("div", { staticClass: "relative" }, [
    _c("ul", [
      _c("li", [
        _vm._v("Cəmi : " + _vm._s(parseFloat(_vm.result.priceTotal).toFixed(2)))
      ]),
      _vm._v(" "),
      _c("li", [_vm._v("Ədv : " + _vm._s(_vm.result.edv) + " %")]),
      _vm._v(" "),
      _c("li", [
        _vm._v("Yekun : " + _vm._s(parseFloat(_vm.result.total).toFixed(2)))
      ])
    ])
  ])
}
