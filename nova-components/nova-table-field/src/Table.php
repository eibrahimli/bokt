...
namespace Eibrahimli\NovaTableField;
...
class Table extends Field
{
    ...
    public function preDefinedColumns($columns): Table {
        return $this->withMeta(['preDefinedColumns' => $columns]);
    }
     ...
     * @return $this
     */
    public function maxRows($max): Table
    {
