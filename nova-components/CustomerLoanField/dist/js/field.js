...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-customer-loan-field', __webpack_require__(3));
  Vue.component('detail-customer-loan-field', __webpack_require__(6));
  Vue.component('form-customer-loan-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            fields: ['calculated_price', 'interested_price', 'main_price']
        };
    },
    ...
    watch: {
        value: function value(val) {
            ...
            this.elements.forEach(function (el) {
                if (_this.fields.includes(el.field.attribute)) {
                    console.log(el);
                    el.value = val;
                }
            });
